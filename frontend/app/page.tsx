                      ...
                      <div>
                        ...
                        <dl className="flex flex-col gap-1 text-sm text-muted-fg">
                          ...
                          <div className="flex items-center gap-2 flex-wrap mt-1">
                            ...
                            {/* Settlement Executing - autopay actively running (transient state) */}
                            {selectedCircle.state === 'settlement_executing' && (
                    ...
                    {selectedCircle.state !== 'open' && (
                      <div className="mb-2 p-2.5 rounded-lg bg-yellow-500/10 border border-yellow-500/30 text-yellow-400 text-xs">
                        <div className="flex items-center gap-1.5">
                          ...
                          {selectedCircle.state === 'settlement_in_progress' || selectedCircle.state === 'settlement_executing'

      ...
      return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-gray-900 via-gray-950 to-black">
          <div className="max-w-md w-full">
            <div className="rounded-2xl border border-red-900/50 bg-gradient-to-br from-red-950/30 to-gray-950/50 p-8 shadow-2xl backdrop-blur-sm">
              {/* Error Icon */}
              ...
              {process.env.NODE_ENV === 'development' && this.state.error && (
                <div className="mb-6 rounded-lg bg-black/40 p-4 border border-gray-800">
